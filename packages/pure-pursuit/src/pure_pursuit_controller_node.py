...
class PurePursuitController(object):
    ...
    def __init__(self):
        self.node_name = "Pure Pursuit Controller"
        ...
        self.sub_seglist_filtered = rospy.Subscriber("~seglist_filtered", SegmentList, self.process_filtered_segments, queue_size=1)
    ...
    def process_filtered_segments(self, segment_list_msg):
        self.loginfo("filtered Segments Callback!")
